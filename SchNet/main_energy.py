...
def main():
    ...
    parser.add_argument('--input_file', type=str, required=True, help='Path to the input database file')
    parser.add_argument('--model_save_path', type=str, required=True, help='Path to save the trained model')
    parser.add_argument('--gpu', action='store_true', help='Use GPU for training')
    args = parser.parse_args()

    # Load dataset, focusing only on energy
    dataset = ASEAtomsData(args.input_file, load_properties=['energy'])
    ...
    print(f"Energy model saved successfully to {args.model_save_path}")
